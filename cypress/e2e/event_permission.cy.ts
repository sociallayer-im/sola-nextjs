...
describe('Show "Publish Request"', () => {
    it('everyone 时候不显示', () => {
        ...
        cy.contains('Permission to create and apply').click()
        cy.contains('Everyone').click()
        cy.contains('Save').click()
        cy.contains('success')

        cy.contains('seedaobeta').click()
