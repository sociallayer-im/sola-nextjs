...
export function locateTimeTransfer(time: Date, timezone: string) {
    ...
    return dayjs.tz(`${year}-${month}-${date} ${hour}:${minute}`, timezone).toISOString()
}
