            ...
            <div className={styles['footer']}>
               <div className={styles['left']}>
                   <svg xmlns="http://www.w3.org/2000/svg" width="39" height="27" viewBox="0 0 39 27" fill="none">
                       ...
                       <path d="M16.3831 15.2131H12.8724C11.9011 15.2131 11.1171 14.429 11.1171 13.4577C11.1171 12.4864 11.9011 11.7024 12.8724 11.7024H16.3831C17.3544 11.7024 18.1385 12.4864 18.1385 13.4577C18.1385 14.429 17.3544 15.2131 16.3831 15.2131Z" fill="#6CD7B2"/>
                       <path d="M33.9366 15.2131H30.4259C29.4546 15.2131 28.6705 14.429 28.6705 13.4577C28.6705 12.4864 29.4546 11.7024 30.4259 11.7024H33.9366C34.9079 11.7024 35.6919 12.4864 35.6919 13.4577C35.6919 14.429 34.9079 15.2131 33.9366 15.2131Z" fill="#6CD7B2"/>
                       <path d="M16.3831 14.0429C16.0554 14.0429 15.798 13.7854 15.798 13.4578V7.6066C15.798 7.27894 16.0554 7.02148 16.3831 7.02148C16.7108 7.02148 16.9682 7.27894 16.9682 7.6066V13.4578C16.9682 13.7737 16.7108 14.0429 16.3831 14.0429Z" fill="#FF7BAC"/>
                       <path d="M16.3832 5.85132C15.4119 5.85132 14.6278 6.63537 14.6278 7.60667V13.4578C14.6278 14.4291 15.4119 15.2132 16.3832 15.2132C17.3544 15.2132 18.1385 14.4291 18.1385 13.4578V7.60667C18.1385 6.63537 17.3544 5.85132 16.3832 5.85132Z" fill="#272928"/>
                       <path d="M30.4259 14.0429C30.0983 14.0429 29.8408 13.7854 29.8408 13.4578V7.6066C29.8408 7.27894 30.0983 7.02148 30.4259 7.02148C30.7536 7.02148 31.0111 7.27894 31.0111 7.6066V13.4578C31.0111 13.7737 30.7536 14.0429 30.4259 14.0429Z" fill="#FF7BAC"/>
                       <path d="M30.4259 5.85132C29.4546 5.85132 28.6705 6.63537 28.6705 7.60667V13.4578C28.6705 14.4291 29.4546 15.2132 30.4259 15.2132C31.3972 15.2132 32.1812 14.4291 32.1812 13.4578V7.60667C32.1812 6.63537 31.3972 5.85132 30.4259 5.85132Z" fill="#272928"/>
                   </svg>
