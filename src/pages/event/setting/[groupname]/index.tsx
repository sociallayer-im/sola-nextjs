...
function Dashboard() {
    ...
    const getGroupTrack = async (groupId: number) => {
      const tracks = await getTracks({groupId: groupId})
      setTracks(tracks)
    }
                        ...
                        <div className={'dialog-inner'}>
                            <div className='create-badge-page-form'>
                                <div className={'dialog-des'}>
                                    Default time zone for group event, but you can still change it when creating the
                                    event. If keep it blank, the default time zone will follow the operating system.
                                </div>
