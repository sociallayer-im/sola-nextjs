...
function ComponentName(props: { group: Group }) {
    ...
    const now = new Date()
    //const [dayList, setDayList] = useState(getCalendarData())
    ...
    useEffect(() => {
        if (swiperRef.current && ready) {
            ...
            swiperRef.current.slideTo(todayIndex - offset, 0)
        }
    }, [swiperRef, ready])
        ...
        <div className={styles['schedule-head']}>
            <div className={styles['page-center']}>
                ...
                <div className={styles['schedule-menu-1']}>
                    <EventLabels data={['tag1', "tag2", "tag3", "tag3"]} value={[]} showAll={true}/>
                ...
                <div className={styles['page-center']}>
                    <div className={styles['schedule-menu-2']}>
                        <div className={styles['mouth']}>
                            ...
                            <div className={styles['to-today']}>Today</div>
                        </div>
                        {
                            !!user.id &&
                            <div className={styles['show-joined']} onClick={e => {
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21"
                                     fill="none">
                                    <path className={styles['show-joined-normal']}
            ...
            <div className={`${styles['page-center-full']} ${styles['height100']}`}>
                { ready &&
                    <Swiper
                        ...
                        {
                            dayList.current.map((item: any, index) => {
