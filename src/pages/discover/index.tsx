...
function Discover({eventGroups, popupCities, events } : {
    ...
    return <div className={styles['discover-page']}>
        <div className={styles['center']}>
                                    ...
                                    <Link href={`/event/${featured.group.username || featured.group.handle}`}
                                        ...
                                        <div className={styles['cover']}>
                                            {!!featured.image_url ?
                                                ...
                                                <div className={styles['default-cover']}><span>{featured.title}</span>
                                                </div>
                                            }
                                        </div>
                                        <div className={styles['detail']}>
                                            ...
                                            <div className={styles['item']}>
                                                <ImgLazy width={32} height={32}
                                                         src={featured.group.image_url || defaultAvatar(featured.group_id)}/>
            ...
            <div className={styles['goto-list']}>
                {!!user.id && <>
                    <Link href={'/'}
                          onClick={e => {
                              e.preventDefault();
                        ...
                        <div className={styles['name']}>{lang['Profile_User_MindBadge']}</div>
                    </Link>
                    <Link href={`/profile/${user.userName}`}
                        ...
                        <div className={styles['name']}>{lang['My_Badges']}</div>
                    </Link>
                    <Link href={`/profile/${user.userName}?tab=3`}
                        ...
                        <div className={styles['name']}>{lang['My_Groups']}</div>
                    </Link>
                    <Link href={`/profile-edit/${user.userName}`}
                        ...
                        <div className={styles['name']}>{lang['Activity_Setting_Btn']}</div>
                    </Link>
                ...
                <Link href={'https://social-layer.notion.site/Use-Badges-531bcb47d3694d45bd6c73da99b1ad6f?pvs=4'}
                      target='_blank'
                    ...
                    <div className={styles['name']}>{lang['What_s_badge']}</div>
                </Link>
                <Link href={'/'}
                    ...
                    <div className={styles['name']}>{lang['Development_Doc']}</div>
                </Link>
                <Link href={'https://twitter.com/SocialLayer_im'} target='_blank'
                    ...
                    <img src="/images/x.jpg" alt="" width={32} height={32}/>
