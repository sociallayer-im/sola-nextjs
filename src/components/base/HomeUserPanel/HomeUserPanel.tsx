...
import {Badge, Membership, queryBadge} from "@/service/solas";
        ...
        {!!eventGroup &&
            <div className={'center'}>
                <div className={'group-card'}>
                    ...
                    { !!eventGroup &&
                        <Link href={`/group/${eventGroup?.username}?tab=1`} className={'group-badge'}>
                            <div className={'left'}>
                                {
                                    groupBadges.map((badge, index) => {
                                        return <ImgLazy key={index} src={badge.image_url} alt="" width={24} height={24}/>
                                    })
                                }
                                {`Issued recently`}
                            </div>
