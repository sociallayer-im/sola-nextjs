                    ...
                    <div className={styles['detail']}>
                        ...
                        }
                        {
                            props.item.event?.participants?.length > 2 ?
                                <span>{`and ${props.item.event?.participants?.length - 2} people registered for the event`}</span>
                                : <span>{`registered for the event`}</span>
                        }
                    </div>
                }
            </div>
                ...
                <>
                    {hasJoin ?
                        <div className={styles['checked']}>
                            ...
                            <span style={{color: '#38E699', fontSize: '12px', marginLeft: '4px'}}>Registered</span>
                        </div>
