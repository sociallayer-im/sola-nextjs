...
const langEN = {
    ...
    Activity_My_Register: 'My registered events',
    ...
    Activity_Form_online_address: 'Meeting URL(Optional)',
    ...
    Group_regist_confirm_dialog: 'This group will be created with name: ',
    Group_regist_des: 'Badges are send to members\nin the name of the organization',
    Group_regist_title: 'Set a unique group name!',
    ...
    Badgebook_Dialog_Choose_Badge: 'Choose from badges you Created',
    ...
    Meeting_Others_Title: 'Online meeting url',
    Event_Card_Apply_Btn: 'Join Event',
    ...
    Ticket_Type_Setting: 'Ticket Setting',
    Ticket: 'Ticket',
