...
const langCN: LangConfig = {
  ...
  Regist_Input_Placeholder: '你的群组名',
  Regist_Profile_Input_Placeholder: '你的用户名',
  Regist_Input_Validate: slotLang('不能超过 {n} 个字符'),
  Regist_Input_Validate_2: slotLang('不能少于 {n} 个字符'),
  Regist_Input_Validate_3: '包含非法字符',
  Regist_Input_Validate_4: slotLang('包含非法字符: {n}'),
  ...
  Promo_Code: '折扣码',
  Generated_History: '生成记录',
  Discount_Off: '折扣',
  Amount_Off: '减免金额',
  Can_Be_Used: '可使用',
  Times: '次',
  Valid_Date: '有效日期至',
  Label_Optional: '标签（选填）',
  Generate: '生成',
  Promo_Code_Detail: '折扣码详情',
  You_Have_Generated_Code: slotLang('你已经生成了一个{1}折扣码'),
  Please_Sending_Until: '有效期至：',
  Remaining_Uses: '剩余次数：',
  Usage_History: '使用记录',
  Event: '活动',
  Ticket_Type: '票种',
  Need_To_Have_Badge: '需要徽章',
  Crypto: '加密货币',
  ...
  Final_Price: '最终价格',
  Balance: '余额',
  Payments_Will_Be_Sent_To: '支付将发送到：',
